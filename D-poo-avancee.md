...
Cette partie du TP va vous permettre de perfectionner encore votre maîtrise de la POO en JS et notamment de travailler sur les concepts d'héritage, de composition, sur les méthodes et propriétés privées, statiques, et sur les méthodes get/set.

**C'est parti !**

## Sommaire <!-- omit in toc -->
- [D.1. Héritage : La classe Img](#d1-héritage-la-classe-img)
- [D.2. _Composition :_ La classe VideoItem](#d2-composition-la-classe-videoitem)
- [D.3. _Composition :_ La classe VideoList](#d3-composition-la-classe-videolist)
- [D.4. _Propriétés et méthodes statiques :_ La classe PageRenderer](#d4-propriétés-et-méthodes-statiques-la-classe-pagerenderer)
- [D.5. _Setter & Getter :_ La propriété `videos`](#d5-setter-getter-la-propriété-videos)

## D.1. Héritage : La classe Img
...
## D.2. _Composition :_ La classe VideoItem
...
## D.3. _Composition :_ La classe VideoList
...
## D.4. _Propriétés et méthodes statiques :_ La classe PageRenderer
...
## D.5. _Setter & Getter :_ La propriété `videos`
